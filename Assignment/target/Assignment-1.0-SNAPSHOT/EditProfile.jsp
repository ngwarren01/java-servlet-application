...
<%
    Customer customer = (Customer) session.getAttribute("customer_record");
%>
...
<form action="CustomerController" method="post">
    <table>
        ...
        <td>
            <%
                out.println("<input type=\"text\" hidden required name=\"customerNumber\" readonly value=\"" + customer.getId()+"\"");
        ...
        <%
            if(customer.getSalesrepemployeenumber() == null){
                out.println("<input list= \"employees\" hidden  name =\"salesEmployeeNumber\" id =\"salesemp\" style=\" width: 200px\"" +
                        " value=\"None\" required>");
                System.out.println("None");
            }
            else{
                out.println("<input list= \"employees\" hidden name =\"salesEmployeeNumber\" id =\"salesemp\" style=\" width: 200px\" value=\"" +customer.getSalesrepemployeenumber().getId()+ "\" required>");
                System.out.println(customer.getSalesrepemployeenumber().getId());

            }
        %>
        <%
            out.println("<input type=\"text\" hidden required name=\"profile\" readonly value=\"profile\"");
        %>
