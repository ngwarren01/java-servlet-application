...
<div style="display: flex; justify-content: space-between; align-items: center;">
    <h1 class="cool-heading">Employee Records</h1>
    <button class="back-button" onclick="backButton()">Back</button>
</div>
<%--Search Form--%>
<br>
<div style="display:flex; padding: 5px; width:1000px">
    <form class="form-inline md-form mr-auto mb-4" action="EmployeeDetailLogic" method="get">
        <input class="form-control mr-sm-2" type="text" aria-label="Search" size="50"
               name="keyword" placeholder="Input Employee Number or Employee Name ONLY !" />
        ...
        <select class="form-control" id="direction" name="direction">
            <option value="ASC">Sort By Lowest Employee Number</option>
            <option value="DESC">Sort By Highest Employee Number</option>
        </select>
...
<nav aria-label="Navigation for Employee">
    <ul class="pagination">
        <%
        ...
        <%
            ...
            out.println("<a class=\"page-link\" href=\"" + "EmployeeDetailLogic?recordsPerPage=" + recordsPerPage
...
<div class="form-popup" id="myForm">
    <form action="EmployeeController" class="form-container" method="post">
        ...
        <fieldset>
            ...
            <br>Employee Number:<input type="text" name="employeeNumber" required />
            <br>Last Name: <input type="text" name="lastName" required />
            <br>First Name:<input type="text" name="firstName" required />
            <br>Extension: <input type="text" name="extension" required/>
            <br>Email: <input type="text" name="email" required/>

            <br>

            <%
                out.println("<label for=\"officeCode\">Office Code: </label>");
                out.println("<input list= \"offices\"  name =\"officeCode\" id =\"officeCode\" style=\"width:200px\" required>");
                out.println("<datalist id = \"offices\">");
                List<Office> office = (List<Office>) request.getAttribute("office_records");
            ...
            %>
            <br>Reports To: <input type="text" name="reportsTo"/>
            <br>Job Title: <input type="text" name="jobTitle" required/>
        </fieldset>
        <button type="submit" class="btn">Add Employee Record</button>
