...
@WebServlet(name = "OfficeDetailLogic", value = "/OfficeDetailLogic")

public class OfficeDetailLogic extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //Page Navigation
        try {
            int rows = empbean.getNumberOfRowsOffice(keyword);
            ...
            List<Office> office_rec = empbean.readOffice(currentPage, recordsPerPage, keyword, direction);
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("OfficeDetail.jsp");
